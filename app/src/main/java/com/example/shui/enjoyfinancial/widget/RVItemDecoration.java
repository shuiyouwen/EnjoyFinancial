package com.example.shui.enjoyfinancial.widget;
...
public class RVItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private RVItemDecoration(@LinearLayoutCompat.OrientationMode int orientation, int decoration, @ColorInt int color, int lineSize) {
    ...
    public RVItemDecoration(@ColorInt int color, float lineHeightDp) {
        this(LinearLayoutManager.VERTICAL, Utils.dip2px(App.sContext, lineHeightDp), color, Utils.dip2px(App.sContext, lineHeightDp));
    }
